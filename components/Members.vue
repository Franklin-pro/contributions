<template>
  <div>
    <UModal v-model="openModal" title="Modal with title">
      <div class="p-4">
        <h1 class="font-semibold text-2xl text-green-500">Create Member</h1>
        <UForm :state="state" class="space-y-4" @submit="onSubmit">
          ...
          <UButton type="submit" size="lg"> Create Member </UButton>
        </UForm>
      </div>
    </UModal>

    <div class="flex items-center flex-wrap justify-between pb-4">
      <h1 class="font-semibold text-2xl text-green-500">All Members</h1>
